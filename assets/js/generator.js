...
const Generator = {
  ...
  async build(config) {
    ...
    'academic_setup','admissions','approvals','diary','digital_library','flyer','gallery','students','sow','payments_online','timetable-generator','admin-data','feature-guide','hmg-ecosystem','contact','about','index','login'];
