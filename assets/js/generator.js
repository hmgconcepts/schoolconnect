...
const Generator = {
  ...
  async build(config) {
    ...
    const specialIds = ['payment-history', 'cbt','cbt-prompts','cbt-exam','certificates','entrance','teacher-overview','inbox','messages','notifications','voting','report-cards','idcards','analytics','apply','exam-register','profile','change-password','cbt-multi','surveys','checkin','checkin-staff','geofence-settings'];
