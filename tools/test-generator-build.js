...
async function build(kind){
 ...
 const zip=await JSZip.loadAsync(buf), names=Object.keys(zip.files); const must=['index.html','login.html','forgot-password.html','change-password.html','dashboard.html','cbt-exam.html','cbt-multi.html','report-cards.html','assets/js/cbt-engine.js','assets/js/report-engine.js','assets/js/data-portability.js','assets/js/v57-enhancements.js','database/complete-schema.sql','database/demo-users.sql','database/demo-seed.sql','assets/img/logo.svg'];
 ...
 if(!sql.includes('sc_cbt_answer_matches')||!sql.includes('identity_engine_version')||!sql.includes('FINAL V5.7 SELF-SUFFICIENCY CHECK')||!sql.includes('V5.7 FINAL PROFESSIONAL AUDIT ENHANCEMENTS'))throw new Error(kind+' has stale schema');
