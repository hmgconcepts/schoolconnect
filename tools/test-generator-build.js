...
async function build(kind){
 ...
 const zip=await JSZip.loadAsync(buf), names=Object.keys(zip.files); const must=['index.html','login.html','dashboard.html','cbt-exam.html','cbt-multi.html','report-cards.html','assets/js/cbt-engine.js','assets/js/report-engine.js','database/complete-schema.sql','database/cbt-v5.1-zero-score-hotfix.sql','database/cbt-v5.1.1-getter-school-settings-fix.sql','database/v5.3-platform-enhancements.sql','database/demo-seed.sql','assets/img/logo.svg'];
