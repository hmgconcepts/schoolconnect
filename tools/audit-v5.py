...
ok('V9.5 wizard: engine-version check + post-generation audit + provenance badges',all(x in (ROOT/'timetable-generator.html').read_text() for x in ['engineStale','reconcile','removeGhosts','tt-audit','_addedIds','📦']) and "'engine','9.5'" in schema)
