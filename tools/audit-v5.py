...
ok('V9.7 CBT prompts end with the required sentence ×3 + self-check blocks',(ROOT/'cbt-prompts.html').read_text().count('Now output/generate the downloadable CSV only.')==3 and (ROOT/'cbt-prompts.html').read_text().count('SELF-CHECK BEFORE OUTPUT')==3)
