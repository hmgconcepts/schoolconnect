...
RUNTIME=[
 ...
 'database/complete-schema.sql','database/cbt-v5.1-zero-score-hotfix.sql','database/cbt-v5.1.1-getter-school-settings-fix.sql','database/v5.3-platform-enhancements.sql','database/v5.4-portability-cbt-metrics.sql','database/v5.5-registered-cbt-identity.sql','database/v5.6-daily-fees-cbt-reset-teacher-scope.sql','database/demo-seed.sql','database/demo-users.sql','database/v9.0-user-lifecycle.sql','database/v9.1-enterprise-pack.sql','database/v9.2-access-and-fixes.sql','database/v9.4-fees-and-exams.sql','database/v9.7-leadership-access.sql','database/v9.9-aid-editors-subjects.sql','database/v10.0-fee-match-and-staffpay.sql','database/v10.1-staffpay-attendance-vetting.sql','database/v8.7-payroll-rebuild.sql','database/v8.5-payroll-net-fix.sql','database/v8.4-assignment-dl-points.sql','database/v8.2-voting-scope-and-dl.sql','database/v7.9-timetable-flex-and-class-scope.sql',
