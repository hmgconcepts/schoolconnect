...
RUNTIME=[
 'assets/css/style.css','assets/js/app.js','assets/js/analytics.js','assets/js/cbt-engine.js','assets/js/cbt-types.js','assets/js/cbt-richtext.js','assets/js/cbt-speech.js','assets/js/chatbot.js',
 'assets/js/crud.js','assets/js/demo.js','assets/js/demo-sample-data.js','assets/js/recovery.js','assets/js/enterprise.js','assets/js/license.js',
 ...
 'assets/js/site-help.js','assets/js/super.js','assets/js/voting.js','assets/js/archive-hub.js','assets/js/cbt-archive.js',
 'database/complete-schema.sql','database/cbt-v5.1-zero-score-hotfix.sql','database/cbt-v5.1.1-getter-school-settings-fix.sql','database/v5.3-platform-enhancements.sql','database/v5.4-portability-cbt-metrics.sql','database/v5.5-registered-cbt-identity.sql','database/v5.6-daily-fees-cbt-reset-teacher-scope.sql','database/demo-seed.sql','database/demo-users.sql','database/v9.0-user-lifecycle.sql','database/v9.1-enterprise-pack.sql','database/v9.2-access-and-fixes.sql','database/v9.4-fees-and-exams.sql','database/v9.7-leadership-access.sql','database/v9.9-aid-editors-subjects.sql','database/v10.0-fee-match-and-staffpay.sql','database/v10.1-staffpay-attendance-vetting.sql','database/v10.2-acl-status-manager.sql','database/v10.3-cbt-advanced-types.sql','database/v10.4-cbt-multisubject-rls.sql','database/v10.5-dl-cbt-link.sql','database/v10.6-cbt-review-community.sql','database/v10.7-fee-locks-arrears.sql','database/v10.8-fee-recompute.sql','database/v10.9-lock-coverage.sql','database/v10.9b-fee-doctor.sql','database/v11.0-timetable-pro.sql','database/v11.7-admission-year.sql','database/v11.9-voting-integrity.sql','database/v12.0-audit-columns.sql','database/v12.2-photo-sync.sql','database/v12.3-write-columns.sql','database/v12.5-schema-doctor.sql','database/v12.6-relink.sql','database/v12.7-archive-restore.sql','database/v8.7-payroll-rebuild.sql','database/v8.5-payroll-net-fix.sql','database/v8.4-assignment-dl-points.sql','database/v8.2-voting-scope-and-dl.sql','database/v7.9-timetable-flex-and-class-scope.sql',
 'database/README.md','assets/img/demo-signature.svg','assets/img/founder-adewale.jpg','CBT_AND_REPORTCARD_GUIDE.md','DEPLOYMENT-GUIDE.md'
]
RICH=['platform-health.html','developer.html','idcards.html','voting.html','messages.html','cbt-exam.html','cbt-multi.html','cbt.html','report-cards.html','student-profile.html','academic-records.html','profile.html','timetable-generator.html','admin-data.html','storage.html','health.html','login.html','change-password.html','forgot-password.html','rubrics.html','transcripts.html','analytics.html','fees.html','settings.html','entrance.html','exam-register.html','academic_setup.html','certificates.html','admissions.html','approvals.html','diary.html','digital_library.html','sow.html','exam-timetable.html','timetable.html','assignments.html','license.html','punctuality.html','checkin-staff.html','checkin.html','cbt-prompts.html','attendance.html']
